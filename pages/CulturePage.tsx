        ...
        <div className="bg-white">
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
                    <h2 className="text-4xl font-bold text-masa-charcoal mb-6">Help Us Keep Traditions Alive</h2>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        ...
                        <button onClick={() => navigateTo('membership')} className="bg-white border-2 border-purple-600 text-purple-600 px-8 py-4 rounded-full font-bold hover:bg-purple-50 transition-all">
                            Become a Member
                        </button>
