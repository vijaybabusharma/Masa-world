...
const CommunityVoicesPage: React.FC<NavigationProps> = ({ navigateTo }) => {
    return (
        <PolicyPageLayout navigateTo={navigateTo} title="Community Voices">
            <p className="text-lg text-gray-600 mb-12 text-center max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-50 p-8 rounded-2xl relative">
                    ...
                    <p className="text-base text-gray-700 italic mb-6 relative z-10 pt-4 leading-relaxed">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Student Volunteer, 3 Years</p>
                        </div>
                    </div>
                </div>
