...
const galleryData = [
    ...
    { id: 5, category: 'Conferences & Seminars', title: 'National Youth Conclave', location: 'Bangalore', date: 'May 15, 2024', imageUrl: 'https://images.unsplash.com/photo-1544531586-fde5298cdd40?auto=format&fit=crop&w=800&q=80', description: 'A platform for dialogue on national issues concerning youth. Policymakers and student leaders engaged in fruitful discussions on education reform.', tags: ['Conference', 'Youth', 'Policy', 'Debate'] },
