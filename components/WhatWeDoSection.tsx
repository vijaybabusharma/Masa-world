        ...
        <section className="py-16 bg-gray-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12 max-w-4xl mx-auto">
                    <span className="text-xs font-bold uppercase tracking-[0.3em] text-masa-orange opacity-80">OUR PILLARS</span>
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-masa-charcoal mt-4 mb-6 leading-tight">{sectionSettings.title}</h2>
                        ...
                        return (
                            <div key={pillar.id} className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-xl hover:shadow-[0_32px_64px_-12px_rgba(0,0,0,0.1)] hover:-translate-y-3 transition-all duration-500 flex flex-col group">
                                <div className="flex items-center gap-6 mb-8">
                                    ...
                                    <span className={`text-[10px] font-bold uppercase tracking-widest px-4 py-2 rounded-full ${pillarColors.bg} ${pillarColors.text}`}>{pillar.label}</span>
                                </div>
                                <h3 className="text-3xl font-bold text-masa-charcoal mb-4 tracking-tight group-hover:text-masa-orange transition-colors duration-300">{pillar.title}</h3>
                                ...
                                <button 
                                    ...
                                    className="font-bold text-xs uppercase tracking-widest text-masa-blue hover:text-masa-orange flex items-center mt-auto transition-all group-hover:gap-2"
                                >
